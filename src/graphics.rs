...
impl WireLayoutCommand {
	...
	pub fn as_string(self) -> String {
		match self {
			...
			WireLayoutCommand::MoveHorizontal(x) => format!("WireLayoutCommand::MoveHorizontal({x:.3})"),
			WireLayoutCommand::MoveVertical(y) => format!("WireLayoutCommand::MoveVertical({y:.3})"),
			WireLayoutCommand::Move((x, y)) => format!("WireLayoutCommand::Move(({x:.3}, {y:.3}))"),
			WireLayoutCommand::MoveXTo(x) => format!("WireLayoutCommand::MoveXTo({x:.3})"),
			WireLayoutCommand::MoveYTo(y) => format!("WireLayoutCommand::MoveYTo({y:.3})"),
			WireLayoutCommand::MoveTo((x, y)) => format!("WireLayoutCommand::MoveTo(({x:.3}, {y:.3}))"),
